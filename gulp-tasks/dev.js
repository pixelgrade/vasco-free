...
stylesComponents.description = 'Compiles Sass and uses autoprefixer';
...
function scriptsConcatenate() {
    return gulp.src( jsFiles )
        .pipe( plugins.concat( 'main.js' ) )
        .pipe( gulp.dest( './assets/js/' ) );
}
scriptsConcatenate.description = 'Concatenate all JS into main.js and wrap all code in a closure';
gulp.task( 'scripts', scriptsConcatenate );
...
watchAll.description = 'Watch for changes to various files and process them';
gulp.task( 'watch', gulp.series('compile', watchAll) );

function watchVariation() {
    let variation = config.theme_name;
...
watchVariation.description = 'Watch for changes to the variation synced files and directories and sync them';
gulp.task( 'watch-variation', gulp.series('sync-variation-specific-files', watchVariation) );
