...
<section class="no-results not-found">
	<div class="page-content entry-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p class="entry-content"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', '__components_txtd' ); ?></p>
			...
			<p class="entry-content"><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', '__components_txtd' ); ?></p>
