			...
			$config = array(
			    ...
			    'fields' => array(
				    ...
				    'title'             => array(
					    ...
					    'rows'     => 3,
					    'default'  => 'Get familiar with the wanderlust',
					    'section'  => 'content',
					    'priority' => 20,
				    ),
				    'description'          => array(
					    ...
					    'default'  => 'Hey, traveller lover! I\'m Jake and for the last couple of years I\'ve been living on the go. It was a blast and I\'ve learned so much along the way. So I put together some guides about my experiences that I hope you\'ll enjoy. Ready for a sneak peekf?',
					    'section'  => 'content',
					    'priority' => 30,
				    ),
				    'button_text'          => array(
					    ...
					    'default'  => 'It\'s your first glance? Don\'t be shy, start here',
					    'section'  => 'content',
					    'priority' => 40,
				    ),
				    'button_url'           => array(
