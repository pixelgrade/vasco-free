...
/******/ 	return __webpack_require__(__webpack_require__.s = "./variations/vasco/ts/App.ts");
/******/ })
/************************************************************************/
/******/ ({
...
function (_BaseComponent) {
  ...
  _createClass(Blob, [{
    ...
    value: function morph() {
      ...
      var opts = jquery__WEBPACK_IMPORTED_MODULE_0___default.a.extend({
...
function (_BaseComponent) {
  ...
  _createClass(Header, [{
    ...
    value: function bindEvents() {
      ...
      _base_ts_services_window_service__WEBPACK_IMPORTED_MODULE_3__["WindowService"].onResize().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeWhile"])(function () {
...
/* harmony import */ var circletype__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! circletype */ "circletype");
...
function (_BaseTheme) {
  ...
  function Vasco() {
    ...
    _components_base_ts_services_global_service__WEBPACK_IMPORTED_MODULE_9__["GlobalService"].onCustomizerRender().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["debounceTime"])(300)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["takeWhile"])(function () {
      return _this.subscriptionActive;
    })).subscribe(function () {
      _this.groupWidgets();
    ...
    _components_base_ts_services_global_service__WEBPACK_IMPORTED_MODULE_9__["GlobalService"].onCustomizerChange().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["debounceTime"])(300)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["takeWhile"])(function () {
      return _this.subscriptionActive;
    })).subscribe(function () {
      _this.prepareFeatureHover();
  ...
  _createClass(Vasco, [{
    ...
    value: function handleCards() {
      ...
      $cards.each(function (i, obj) {
        var $card = jquery__WEBPACK_IMPORTED_MODULE_1___default()(obj);
        var $meta = $card.find('.c-card__meta').detach();
        var $primary = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div class="c-card__meta">');
    ...
    value: function generateBlobs() {
      ...
      var smoothness = parseInt(jquery__WEBPACK_IMPORTED_MODULE_1___default()('body').data('blobs-smoothness'), 10) / 100;
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.blob--shape-1').each(function (i, obj) {
        ...
        var blob = new _components_base_ts_components_blob__WEBPACK_IMPORTED_MODULE_10__["Blob"](preset, complexity, smoothness);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.blob--shape-2').each(function (i, obj) {
        var $obj = jquery__WEBPACK_IMPORTED_MODULE_1___default()(obj);
        var blob = new _components_base_ts_components_blob__WEBPACK_IMPORTED_MODULE_10__["Blob"](preset, complexity, smoothness, 1);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.blob--shape-3').each(function (i, obj) {
        var $obj = jquery__WEBPACK_IMPORTED_MODULE_1___default()(obj);
        var blob = new _components_base_ts_components_blob__WEBPACK_IMPORTED_MODULE_10__["Blob"](preset, complexity, smoothness, 2);
      ...
      setTimeout(function () {
        window.requestAnimationFrame(function () {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.blob--shape').closest('.blob').addClass('blob--loaded');
        });
      }, 500);
    }
  }, {
    ...
    value: function positionAnnouncementBar() {
      ...
      var adminBarHeight = jquery__WEBPACK_IMPORTED_MODULE_1___default()('#wpadminbar').outerHeight();
