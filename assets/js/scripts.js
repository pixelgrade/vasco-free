...
function (_BaseTheme) {
  ...
  function Vasco() {
    ...
    _components_base_ts_services_global_service__WEBPACK_IMPORTED_MODULE_9__["GlobalService"].onCustomizerRender().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["debounceTime"])(300)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
      return _this.subscriptionActive;
    })).subscribe(function () {
      _this.groupWidgets();
    ...
    _components_base_ts_services_global_service__WEBPACK_IMPORTED_MODULE_9__["GlobalService"].onCustomizerChange().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["debounceTime"])(300)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeWhile"])(function () {
      return _this.subscriptionActive;
    })).subscribe(function () {
      _this.prepareFeatureHover();
