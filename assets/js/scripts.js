...
function (_BaseComponent) {
  ...
  function Blob(preset, complexity, smoothness) {
    ...
    _this.setPreset(preset + presetOffset);
  ...
  blob_createClass(Blob, [{
    ...
    value: function generatePoints() {
      ...
      for (var _i = 0; _i < points.length; _i++) {
        ...
        var x1 = M1.x * (1 - this.smoothness) + thisPt.x * this.smoothness;
        var y1 = M1.y * (1 - this.smoothness) + thisPt.y * this.smoothness;
        var x2 = M2.x * (1 - this.smoothness) + thisPt.x * this.smoothness;
        var y2 = M2.y * (1 - this.smoothness) + thisPt.y * this.smoothness;
      ...
      path = 'M' + firstPoint; // draw dummy lines to same point to keep a consistent number of points for the shape

      for (var _i2 = 0; _i2 < this.mostSides - this.sides; _i2++) {
